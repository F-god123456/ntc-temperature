...
/*
	STM32F030K6T6 按键口线分配：

		KEY_MENU 键      : PB0    (低电平表示按下)
		KEY_UP 键        : PB1    (低电平表示按下)
		KEY_DOWN 键      : PB2    (低电平表示按下)
		KEY_RETURN 键    : PB3    (低电平表示按下)
		KEY_ONOFF 键     : PB4    (低电平表示按下)
*/
...
static void bsp_InitKeyHard(void)
{
	...
	GPIO_InitStructure.GPIO_Mode = 	GPIO_Mode_IN;			//配置PB0为输入模式
	GPIO_InitStructure.GPIO_PuPd =  GPIO_PuPd_UP;			//配置PB0带上拉输入		
